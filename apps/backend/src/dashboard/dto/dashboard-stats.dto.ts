...
export class LiveOfferDto {
  ...
  @ApiProperty({
    example: 'https://images.unsplash.com/photo-1509042239860-f550ce710b93',
  })
  imageUrl: string;
...
export class DashboardStatsDto {
  ...
  @ApiProperty({
    example: 36,
    description: 'Percentage increase in engagement',
  })
  engagementGrowth: number;

  @ApiProperty({
    example: 12.5,
    description: 'Conversion rate from scans to claims',
  })
...
export class RecentActivityDto {
  ...
  @ApiProperty({
    example: 'New Scan',
    enum: ['New Scan', 'Offer Claimed', 'Voucher Redeemed'],
  })
  type: string;
