...
export class CreateOfferDto {
  ...
  @ApiProperty({
    example: '10% Off All Accessories',
    description: 'Headline of the offer',
  })
  @IsString()
  @IsNotEmpty()
  headline: string;
  ...
  @ApiProperty({
    example: 'Get 10% off on all items in the store today!',
  ...
  @ApiPropertyOptional({
    example: 'https://example.com/claim',
    description: 'Destination for the lead/CTA action',
  })
  @IsString()
  @IsOptional()
  ...
  @ApiPropertyOptional({
    example: 'E1 6AN',
    description: 'Target postcode for hyperlocal visibility',
  })
  @IsString()
  @IsOptional()
